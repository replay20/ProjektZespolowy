...
using MvcdanePracowniks.Models;
using WebApplication1.Models.Data;

namespace WebApplication1.Controllers
{
    public class danePracowniksController : Controller
    {
        private readonly PracownicyContext _context;

        public danePracowniksController(PracownicyContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.danePracowniks.ToListAsync());
        }
